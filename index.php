    ...
    <div class="container-fluid ">
        ...
        <div class="row desktop-bg vh-100">
            ...
            <div class="col-md-5 col-12  ">
                <img src="images/money-ai.png" class="img-fluid man-img" alt="money">
            </div>
        </div>

    </div>
    
    <div class="row  pt-3 mt-5 pb-4 mb-5 vh-100">

       <div class="col-md-5 col-12">
        <div class="card-manual">
           <div class="image text-center">
            <img class="card-img-top" src="images/guide.svg" alt="guide" title="Prediction Guide">
           </div>
            <div class="card-body">
       ...
       <div class="col-md-5 col-12">
        <div class="card-manual">
            <div class="image text-center">
                <img class="card-img-top" src="images/tool1.svg" alt="Card image cap">
            </div>
